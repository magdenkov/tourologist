(function() {
    ...
    InterestDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Interest', 'Tour', 'Bubbl'];

    function InterestDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Interest, Tour, Bubbl) {
        var vm = this;
