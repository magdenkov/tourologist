...
/**
 * Created by Denis Magdenkov on 29/01/2016.
 */
public class MimeTypesUtils {
    ...
    public static final List<String> acceptedImageTypes = newArrayList(MimeTypesUtils.MIME_IMAGE_JPEG,
        MimeTypesUtils.MIME_IMAGE_BMP,
        MimeTypesUtils.MIME_IMAGE_GIF,
        MimeTypesUtils.MIME_IMAGE_PNG);



    public static boolean acceptFile(String filename) {
        String mime = MimeTypesUtils.lookupMimeType(StringUtils.getFilenameExtension(filename));
        return acceptedImageTypes.contains(mime);
    }
