...
public class TourImageResource {
    ...
    @Timed
    public ResponseEntity<TourImageDTO> createTourImage(@RequestBody TourImageDTO tourImageDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<TourImageDTO> updateTourImage(@RequestBody TourImageDTO tourImageDTO) throws URISyntaxException {
